module DmCore
  module ApplicationHelper
    ...
    def flash_notices
      ...
      flash_class = { notice: 'alert-success', error: 'alert-error alert-danger', alert: 'alert-info' }
    ...
    def link_to_add_custom_fields(name, f, association)
      ...
      link_to(name, '#', class: 'add_custom_fields btn btn-xs btn-default', data: { id: id, fields: fields.delete("\n") })
    end
  end
end
