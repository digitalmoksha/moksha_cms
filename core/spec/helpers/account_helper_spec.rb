...
describe DmCore::AccountHelper do
  ...
  it "returns path to the site's protected assets media folder" do
    expect(account_protected_assets_media_folder).to eq "#{Rails.root}/protected_assets/uploads/test"
  end
  
  #------------------------------------------------------------------------------
  it "returns the path of the site's media folder" do
    expect(account_site_assets_media).to eq '/site_assets/uploads/test'
    expect(account_site_assets_media(false)).to eq 'site_assets/uploads/test'
  end
  ...
  it "returns url to the site's media assets" do
    expect(account_site_assets_media_url).to eq 'http://test.example.com/site_assets/uploads/test'
  end
