...
class StateCountryConstants
  ...
  PRIMARY_COUNTRIES_CODE = [['Austria',         'AT'],
                            ['Czech Republic',  'CZ'],
                            ['Finalnd',         'FI'],
                            ['Germany',         'DE'],
                            ['India',           'IN'],
  ...
  PRIMARY_COUNTRIES_NAME = [['Austria',         'Austria'],
