...
describe DmCms::Liquid::Tags::Image, type: :liquid_tag do
  setup_account
  ...
  describe 'html rendering' do
    it 'just an image' do
      ...
      expect(doc).to eq '<img src="/test_img.jpg" />'
    end
    ...
    it 'with height and width' do
      ...
      arguments = nil
      doc = Liquid::Template.parse(content).render(arguments, filters: [DmCms::Liquid::Filters::LiquidFilters])
      expect(doc).to eq '<img width="300" height="200" src="/test_img.jpg" />'
    end
  end
  ...
  describe 'markdown rendering' do
    it 'just an image' do
      ...
      expect(doc.to_html.html_safe).to eq "<p><img src=\"/test_img.jpg\" /></p>\n"
    end
  end
end
