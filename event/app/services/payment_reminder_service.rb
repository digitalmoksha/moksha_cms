class PaymentReminderService
  ...
  def self.payment_reminder_due?(registration)
    return false if !past_due?(registration) || registration.writtenoff_on
    ...
    if start_date < now
      ...
      elsif start_date == registration.workshop.initial_payment_required_on && registration.payment_reminder_sent_on.nil?
